	...
	<div class="container-fluid">
		...
		<div id="navbarbottom" class="navbar-collapse collapse in">
			<ul class="nav navbar-nav navbar-left">
				<li><a href="https://t2-documentation.readthedocs.io/en/latest/index.html" target="_blank">t2 documentation</a></li>
			</ul>
...
<%--<script src="<c:url value="/resources/resizingscript.js"/>"></script>--%>
</body>
</html>
